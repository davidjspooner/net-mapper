...
type TypeDefinition interface {
	Read(ctx context.Context, name string, meta *TokenList, s *Scanner) (Definition, error)
}

type TypeDefinitionFunc func(ctx context.Context, name string, meta *TokenList, s *Scanner) (Definition, error)

func (f TypeDefinitionFunc) Read(ctx context.Context, name string, meta *TokenList, s *Scanner) (Definition, error) {
...
type MibDefinedType interface {
	Definition
	TypeDefinition
	Initialize(ctx context.Context, name string, meta *TokenList, s *Scanner) error
}

type Definer[T MibDefinedType] struct {
}

func (mdd *Definer[T]) Read(ctx context.Context, name string, meta *TokenList, s *Scanner) (Definition, error) {
	var t T
